...
Adjusted R2:
* для моделей с категориальным признаками (одна со всеми факторами, вторая только со значимыми):
`
'log Lik.' 0.02658693 (df=15)
`

* сравнение бинарной модели и модели только со значимыми факторам:
`
'log Lik.' -0.001611127 (df=15)
`

* сравнение бинарной модели и модели со всеми факторами:
` 
'log Lik.' -0.02896824 (df=15)
`
